/*
 * ES8311 melody player for the Waveshare ESP32-P4-WIFI6-Touch-LCD-XC.
 *
...
void setup() {
  ...
  // Keep the power amplifier disabled until ES8311 and I2S are ready.
  digitalWrite(PIN_POWER_AMP, LOW);
