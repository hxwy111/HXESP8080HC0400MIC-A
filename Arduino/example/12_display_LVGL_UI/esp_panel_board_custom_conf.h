 ...
 */
#define ESP_PANEL_BOARD_NAME                "HXESP8080HC0400MIC-A"

/**
 * @brief Panel resolution configuration in pixels
 */
#define ESP_PANEL_BOARD_WIDTH               (720)   // Panel width (horizontal, in pixels)
#define ESP_PANEL_BOARD_HEIGHT              (720)   // Panel height (vertical, in pixels)
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_MIPI_DPI_CLK_MHZ            (30) // 720x720: requested refresh approximately 49.34 Hz
